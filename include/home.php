<section id="slider-wrapper" class="layer-slider-wrapper">
    <div id="layerslider" style="width:100%;height:500px;">
        ...
        <div class="ls-slide" data-ls="transition2d:1;timeshift:-1000;">
            <img src="<?php echo $prefix; ?>/images/slider/fw-1.jpg" class="ls-bg" alt="Slide background"/><img class="ls-l" style="top:157px;left:284px;white-space: nowrap;" data-ls="offsetxin:300;durationin:2000;offsetxout:-300;parallaxlevel:-1;" src="<?php echo $prefix; ?>/images/slider/l1.png" alt=""><img class="ls-l" style="top:20px;left:50%;white-space: nowrap;" data-ls="offsetxin:600;durationin:2000;offsetxout:-600;parallaxlevel:1;" src="<?php echo $prefix; ?>/images/slider/l2.png" alt=""><img class="ls-l" style="top:37px;left:564px;white-space: nowrap;" data-ls="offsetxin:900;durationin:2000;offsetxout:-900;parallaxlevel:4;" src="<?php echo $prefix; ?>/images/slider/l3.png" alt="">
            ...
            <p class="ls-l" style="top:110px;left:83px;font-size:31px;color:#f04705;white-space: nowrap;" data-ls="offsetxin:0;durationin:2000;delayin:2000;easingin:easeOutElastic;rotatexin:90;transformoriginin:50% top 0;offsetxout:-400;parallaxlevel:8;">
                با ما دیده شوید
            </p>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="aside-feature">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <h2 class="h4-font">طراحی اپلیکیشن های موبایل</h2>
                                    
                                    	 <h3 class="h6-font"><i class="fa fa-hand-o-left"></i> طراحی اپلیکیشن برای تمامی وب سایت ها</h3>
                                         <h3 class="h6-font"><i class="fa fa-hand-o-left"></i> طراحی اپلیکیشن های Android و iOS</h3>
                                         <h3 class="h6-font"><i class="fa fa-hand-o-left"></i> پنل مدیریت پیشرفته</h3>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="aside-feature">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <h2 class="h4-font">پکیج های اداری و تجاری</h2>
                                    
                                    	 <h3 class="h6-font"><i class="fa fa-hand-o-left"></i> سیستم های مدیریت مجتمع با فناوری RFID</h3>
                                         <h3 class="h6-font"><i class="fa fa-hand-o-left"></i> سیستم حضور غیاب آنلاین</h3>
                                         <h3 class="h6-font"><i class="fa fa-hand-o-left"></i> سیستم اس ام اس پیشرفته</h3>
                                         <h3 class="h6-font"><i class="fa fa-hand-o-left"></i> مانیتوریگ آنلاین</h3>
                                         <h3 class="h6-font"><i class="fa fa-hand-o-left"></i> طراحی، راه اندازی و پشتیبانی دوربین های مداربسته</h3>
                                         <h3 class="h6-font"><i class="fa fa-hand-o-left"></i> طراحی، راه اندازی و پشتیبانی شبکه های کامپیوتری</h3>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="aside-feature">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <h2 class="h4-font"><a href="<?php echo $prefix; ?>/home/" style="color:#438838">طراحی وب سایت</a> و پرتال</h2>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="aside-feature">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <h2 class="h4-font">سیستم های CRM (تحت وب )</h2>
                                    
                                         <h3 class="h6-font"><i class="fa fa-hand-o-left"></i> سیستم گزارش گیری لحظه ای</h3>
                                         <h3 class="h6-font"><i class="fa fa-hand-o-left"></i> پنل اس ام اس پیشرفته</h3>
                                         <h3 class="h6-font"><i class="fa fa-hand-o-left"></i> امکان گزارش گیری با انواع نمودار و چارت</h3>
                                         <h3 class="h6-font"><i class="fa fa-hand-o-left"></i> امنیت بالا در به همراه دسترسی بالا</h3>
                                         <h3 class="h6-font"><i class="fa fa-hand-o-left"></i> پشتیبانی 24 ساعته</h3>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="aside-feature">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <h2 class="h4-font">SEO و بهینه سازی وب سایت</h2>
                                    
                                         <h3 class="h6-font"><i class="fa fa-hand-o-left"></i> آنالیز کلمات کلیدی</h3>
                                         <h3 class="h6-font"><i class="fa fa-hand-o-left"></i> ثبت در تمام موتورهای جست و جو</h3>
                                         <h3 class="h6-font"><i class="fa fa-hand-o-left"></i> مبتنی بر به روزترین الگوریتم های گوگل</h3>
                                         <h3 class="h6-font"><i class="fa fa-hand-o-left"></i> مانیتوریگ 24 ساعته</h3>
                                         <h3 class="h6-font"><i class="fa fa-hand-o-left"></i> تضمین صفحه اول گوگل</h3>
...
consultation">
    	<div class="panel panel-default">
          ...
          <div id="collapseThree" class="panel-collapse in" style="height: auto;">
            ...
            <p align="center" style="font-size:40px;color:#438838"><i class="fa fa-users"></i></p>
              <p><p align="center">نیاز هر انتخاب خوب ، مشاوره قبل از انتخاب می باشد.</p><p align="justify"> واحد مشاروه شرکت رای وب در جهت رضایت شما، آماده ارائه خدمات مشاوره می باشد. به منظور مشاوره رایگان ، با شماره 66576199 تماس حاصل فرمائید و یا پس از پرکردن فرم <a href="<?php echo $prefix; ?>/order/" style="text-decoration:underline">سفارش</a> منتظر تماس کارشناسان ما باشید. </p>
        ...
        <div class="w-section inverse">
                    ...
                    <div>
                        <h3 class="section-title"><span> آخرین پروژه های <a href="<?php echo $prefix; ?>/home/" style="color:#000">طراحی وب سایت</a></span></h3>
                        <div class="row">
                            <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="text-center">
                            ...
                            <div class="text-center">
                                <a href="<?php echo $prefix; ?>/works/" target="_blank" class="btn btn-lg btn-one mt-20 ext-source">مشاهده نمونه کارها </a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-2 col-sm-4 col-xs-6">
                    <div class="client">
                    	<a href="#">
                    		<img src="<?php echo $prefix; ?>/images/clients/boostan.png" alt="مشتریان طراحی وب سایت رای وب">
                        </a>
                    </div>
                </div>
                 <div class="col-md-2 col-sm-4 col-xs-6">
                    <div class="client">
                    	<a href="#">
                    		<img src="<?php echo $prefix; ?>/images/clients/scards.png" alt="مشتریان طراحی وب سایت رای وب">
                        </a>
                    </div>
                </div>
                 <div class="col-md-2 col-sm-4 col-xs-6">
                    <div class="client">
                    	<a href="#">
                    		<img src="<?php echo $prefix; ?>/images/clients/ano.png" alt="مشتریان طراحی وب سایت رای وب">
                        </a>
                    </div>
                </div>
                 <div class="col-md-2 col-sm-4 col-xs-6">
                    <div class="client">
                    	<a href="#">
                    		<img src="<?php echo $prefix; ?>/images/clients/atieh.png" alt="مشتریان طراحی وب سایت رای وب">
                        </a>
                    </div>
                </div>
                 <div class="col-md-2 col-sm-4 col-xs-6">
                    <div class="client">
                    	<a href="#">
                    		<img src="<?php echo $prefix; ?>/images/clients/barincard.png" alt="مشتریان طراحی وب سایت رای وب">
                        </a>
                    </div>
                </div>
                 <div class="col-md-2 col-sm-4 col-xs-6">
                    <div class="client">
                    	<a href="#">
                    		<img src="<?php echo $prefix; ?>/images/clients/parvazi.png" alt="مشتریان طراحی وب سایت رای وب">
                        </a>
                    </div>
                </div>
            </div>
