...
<head>
    <meta charset="UTF-8">
    <meta name="msvalidate.01" content="B60EFEEBEDB9AAAF7C73C4BF13A9D987"/>
    ...
    <link rel="icon" href="<?php echo $prefix; ?>/images/favicon.gif" type="image/png">
            ...
            <div class="row">
                <div class="col-sm-12">
                   <span class="aux-text hidden-xs pull-right">
                        <strong><h1
                                style="margin:0 !important;font-weight:bold;padding:0;font-size:15px;display:inline-block">
                                طراحی وب سایت</h1> رای وب 44141868 - 021</strong>
                    </span>
                    <nav class="top-header-menu">
                        <ul class="menu">

                            <li class="aux-languages dropdown animate-hover" data-animate="animated fadeInUp"><a
                                    href="#"><span class="language name">فارسی</span></a>
            ...
            <div class="container header-main">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                        <li class="<?php if ((isset($_GET['page']) && $_GET['page'] == 'home') || !isset($_GET['page'])) {
                            echo 'active';
                        } ?> pull-right">
                            <a href="<?php echo $prefix; ?>/" data-close-others="true">صفحه اصلی</a>
                        </li>
                        <li class="<?php if (isset($_GET['page']) && $_GET['page'] == 'article') {
                            echo 'active';
                        } ?> pull-right">
                            <a href="<?php echo $prefix; ?>/article/" class="dropdown-toggle" data-close-others="true">مقالات</a>

                        </li>
                        <li class="<?php if (isset($_GET['page']) && $_GET['page'] == 'hire') {
                            echo 'active';
                        } ?> pull-right">
                            <a href="<?php echo $prefix; ?>/hire/" class="dropdown-toggle" data-close-others="true">استخدام</a>

                        </li>
                        <li class="<?php if (isset($_GET['page']) && $_GET['page'] == 'courses') {
                            echo 'active';
                        } ?> pull-right">
                            <a href="<?php echo $prefix; ?>/courses/" class="dropdown-toggle" data-close-others="true">دوره
                                آموزشی</a>

                        </li>
                        <li class="<?php if (isset($_GET['page']) && $_GET['page'] == 'works') {
                            echo 'active';
                        } ?> pull-right">
                            <a href="<?php echo $prefix; ?>/works/" class="dropdown-toggle" data-close-others="true">نمونه
                                کارها</a>

                        </li>
                        <li class="<?php if (isset($_GET['page']) && $_GET['page'] == 'about') {
                            echo 'active';
                        } ?> pull-right">
                            <a href="<?php echo $prefix; ?>/about/" class="dropdown-toggle" data-close-others="true">درباره
                                ما</a>

                        </li>
                        <li class="<?php if (isset($_GET['page']) && $_GET['page'] == 'contact') {
                            echo 'active';
                        } ?> pull-right">
                            <a href="<?php echo $prefix; ?>/contact/" class="dropdown-toggle" data-close-others="true">ارتباط
                                با ما</a>

                        </li>
                        <li class="<?php if (isset($_GET['page']) && $_GET['page'] == 'order') {
                            echo 'active';
                        } ?> pull-right">
                            <a href="<?php echo $prefix; ?>/order/" class="dropdown-toggle" data-close-others="true">سفارش</a>

                        </li>
                        <li class="<?php if (isset($_GET['page']) && $_GET['page'] == 'video') {
                            echo 'active';
                        } ?> pull-right">
                            <a href="<?php echo $prefix; ?>/video/" class="dropdown-toggle" data-close-others="true"
                               style="color:red">دانلود ویدئو آموزشی</a>
...
<footer class="footer">
    <div class="container">
        <div class="row">
            <div class="col-md-3">
                <div class="col">
                    ...
                    <hr>
                    <ul>
                        <li><i class="fa fa-taxi"></i> تهران - بلوار تعاون - خیابان فرساد شرقی (آلاله) - خیابان عدالت -
                            کوچه 2 غربی - پلاک 33 - واحد 2
                        </li>
                        <li><i class="fa fa-phone"></i> 44958948 - 021</li>
                        <li><i class="fa fa-phone"></i> 44141868 - 021</li>
                        <li><i class="fa fa-fax"></i> 44958941 - 021</li>
                        <li><i class="fa fa-envelope-o"></i><a href="mailto:info@rayweb.ir" title="Email Us">
                                info@rayweb.ir </a></li>
            ...
            <div class="col-md-3">
                <div class="col">
                    ...
                    <hr>
                    <ul>
                        <li><a href="<?php echo $prefix; ?>/"><i class="fa fa-arrow-circle-o-left"></i> صفحه اصلی </a>
                        </li>
                        <li><a href="<?php echo $prefix; ?>/article/"><i class="fa fa-arrow-circle-o-left"></i> مقالات
                                طراحی وب سایت</a></li>
                        <li><a href="<?php echo $prefix; ?>/hire/"><i class="fa fa-arrow-circle-o-left"></i> استخدام</a>
                        </li>
                        <li><a href="<?php echo $prefix; ?>/courses/"><i class="fa fa-arrow-circle-o-left"></i> آموزش
                                طراحی وب سایت </a></li>
                        <li><a href="<?php echo $prefix; ?>/works/"><i class="fa fa-arrow-circle-o-left"></i> نمونه
                                کارها</a></li>
                        <li><a href="<?php echo $prefix; ?>/about/"><i class="fa fa-arrow-circle-o-left"></i> درباره ما</a>
                        </li>
                        <li><a href="<?php echo $prefix; ?>/contact/"><i class="fa fa-arrow-circle-o-left"></i> ارتباط
                                با ما</a></li>
                        <li><a href="<?php echo $prefix; ?>/order/"><i class="fa fa-arrow-circle-o-left"></i> سفارش
                                طراحی وب سایت</a></li>
                        <li><a href="<?php echo $prefix; ?>/press/"><i class="fa fa-arrow-circle-o-left"></i> رای وب در
                                جراید</a></li>
                        <li><a href="<?php echo $prefix; ?>/video/"><i class="fa fa-arrow-circle-o-left"></i> ویدئوهای
                                آموزشی طراحی وب سایت </a></li>
                        <li><a href="<?php echo $prefix; ?>/news/"><i class="fa fa-arrow-circle-o-left"></i> آخرین اخبار
                                فناوری اطلاعات (IT)</a></li>
                    </ul>
            ...
            <div class="social-link">
                <div class="g-plus-button">
                    <div class="g-plusone" data-annotation="none"
                         data-href="https://plus.google.com/communities/107271610650119455714"></div>
                </div>

                <div class="fb-like-button">
                    <div class="fb-like" data-href="https://www.facebook.com/raywebco" data-layout="button"
        ...
        <script type="text/javascript" language="javascript"
                src="http://www.webgozar.ir/c.aspx?Code=3274641&amp;t=counter"></script>
        <noscript><a href="http://www.webgozar.com/counter/stats.aspx?code=3274641" target="_blank">&#1570;&#1605;&#1575;&#1585;</a>
        </noscript>
...
<!-- Plugins -->
<script type="text/javascript"
        src="<?php echo $prefix; ?>/assets/hover-dropdown/bootstrap-hover-dropdown.min.js"></script>
...
<script src="<?php echo $prefix; ?>/assets/layerslider/js/layerslider.kreaturamedia.jquery.js"
