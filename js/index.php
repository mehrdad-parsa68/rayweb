...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/costum.css">
     <!-- Required -->
     <meta name="keywords" content=" طراحی سایت رای وب , ray web , rayweb , رای وب , طراحی سایت , طراحی وب سایت , بهینه سازی وب سایت , سئو , طراحی حرفه ای سایت , استاتیک , فروشگاه اینترنتی , سایت استاتیک, سایت داینامیک , طراحی فروشگاه اینترنتی " />
	<meta name="description" content="شرکت طراحی سایت طرح و رای وب پیشرو در طراحی سایت , بهینه سازی سایت , سئو , طراحی وب سایت و بازاریابی اینترنتی می باشد." />
...
<footer class="footer">
    <div class="container">
            ...
            <div class="col-md-3">
            	<div class="col">
                    ...
                    <form class="form-inline">
                        <div class="input-group">
                            <input type="text" class="form-control exo" placeholder="ایمیل شما...">
                            <span class="input-group-btn">
                                <button class="btn btn-two" type="button">ارسال!</button>
                            </span>
                        </div>
                    </form>
                </div>
        ...
        <div class="row text-center">
        	<div class="col-lg-12 copyright exo" dir="ltr">
            	2014 © Rayweb. All rights reserverd. 
